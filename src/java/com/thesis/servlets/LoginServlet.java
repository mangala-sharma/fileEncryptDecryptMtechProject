...
import com.thesis.dao.CustomerDao;
...
//            Customer u=dao.getelementbyemail(userEmail,userPassword);
            Customer u=dao.getelementbyemaill(userEmail);
            
            if(u==null){
              out.println("<p>invailid</p>");
